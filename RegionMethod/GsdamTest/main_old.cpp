...
//    IPL image_xz_BF=cvCloneImage(src);
//    IPL image_yz_BF=cvCloneImage(src);
//    IPL image_xy_BF=cvCloneImage(src);
//    IPL image_z_BF=cvCloneImage(src);
//    
//    int height=src->height, width=src->width;
//    //    printf("h=%d w=%d\n",height,width);
//    double **c1;
...
//    //    string name5="_xz-map.tif";
//    //    save_img(image_xz,argv[1],name5);
//    //    string name6="_yz-map.tif";
...
//    //    cvMorphologyEx(image_contour,image_open,image_temp,element,CV_MOP_OPEN,3);//最大轮廓进行腐蚀操作后进行形态学开操作
//    
//    cvSmooth(image_xy,image_xy_BF,CV_BILATERAL,-1,1,40,20);//双向滤波(bilateral filtering)，image_xz_BF为输出图像
//    //    cvSmooth(image_xz,image_xz_BF,CV_BILATERAL,-1,1,40,20);
//    //    cvSmooth(image_yz,image_yz_BF,CV_BILATERAL,-1,1,40,20);
//    
//    //    string name8="_xz-bf.tif";
//    //    save_img(image_xz_BF,argv[1],name8);
//    
//    IPL image_xy_BF_binary=cvCreateImage(cvGetSize(image_xy),IPL_DEPTH_8U,1);
//    cvZero(image_xy_BF_binary);//初始化图片，值都为0
//    image_xy_BF_binary=map_binarization(image_xy_BF,image_xy_BF_binary);//大津法二值化map图像
//    
//    //    cvSmooth(image_xz,image_xz_BF,CV_BILATERAL,-1,1,40,20);//双向滤波(bilateral filtering)，image_xz_BF为输出图像
//    //    IPL image_xz_BF_binary=cvCreateImage(cvGetSize(image_xz),IPL_DEPTH_8U,1);
//    //    cvZero(image_xz_BF_binary);//初始化图片，值都为0
...
//    //        for(x=0; x<width-1; x++)
//    //        {
//    //            CvScalar Ixy=cvGet2D(image_xy_BF_binary,y,x);
//    //            printf("ixy0=%f ixy1=%f ixy2=%f\n",Ixy.val[0],Ixy.val[1],Ixy.val[2]);
//    //        }
//    //    }
//    //    cvNamedWindow("1");
//    //    cvShowImage("1",image_xy_BF_binary);
//    //    cvWaitKey(0);
//    //    for(y=0; y<height-1; y++)
//    //    {
//    //        for(x=0; x<width-1; x++)
//    //        {
//    //            CvScalar Ixy=cvGet2D(image_xy_BF_binary,y,x);
//    //            CvScalar n0=cvScalar(255, 0, 0);
//    //            cvSet2D(image_xy_BF_binary,y,x,n0.val[0]-Ixy.val[0]);
//    //        }
//    //    }
//    //    for(y=0; y<height-1; y++)
//    //    {
//    //        for(x=0; x<width-1; x++)
//    //        {
//    //            CvScalar Ixy1=cvGet2D(image_z_BF_binary,y,x);
//    //            CvScalar n01=cvScalar(255, 0, 0);
//    //            cvSet2D(image_z_BF_binary,y,x,n01.val[0]-Ixy1.val[0]);
//    //        }
//    //    }
//    string name17="_xy-bf-binar.tif";
//    save_img(image_xy_BF_binary,argv[1],name17);
//    //    string name7="_xz-bf-binar.tif";
//    //    save_img(image_xz_BF_binary,argv[1],name7);
//    
//    //    IPL image_xy_and_xz=and_two_binary_imgs(image_xy_BF_binary,image_xz_BF_binary);//与操作
//    
//    //
//    //        for(y=0; y<height-1; y++)
//    //        {
...
//    //        cvShowImage("1",image_xy_BF_binary);
//    //        cvWaitKey(0);
//    //    string name22="_binary.tif";
//    //    save_img(image_x_BF_binary,argv[1],name22);
//    //    string name1="_xyz-bf.tif";
//    //    save_img(image_xy_and_z,argv[1],name1);
//    
//    //    string name9="_yz-bf.tif";
//    //    save_img(image_yz_BF_binary,argv[1],name9);
//    //
//    //    string name66="_xy-and-xz.tif";
//    //    save_img(image_xy_and_xz,argv[1],name66);
//    
//    IPL dilate_src=cvCloneImage(image_xy_BF_binary);
//    IPL imagesmoothM=cvCloneImage(dilate_src);
//    IPL imagesmoothM2=cvCloneImage(dilate_src);
//    //
//    cvSmooth(dilate_src,imagesmoothM,CV_MEDIAN,5,5);//中值滤波
//    cvSmooth(imagesmoothM,imagesmoothM2,CV_MEDIAN,3,3);
//    
//    string name2="_img-mf1.tif";
//    save_img(imagesmoothM,argv[1],name2);
//    string name9="_img-mf2.tif";
...
//    
//    cvMorphologyEx(imagesmoothM2,image_close,image_temp,element,CV_MOP_CLOSE,5);//imagesmoothM2进行形态学闭操作，temp为临时变量，需要与原数组大小相同，element为自定义模板，5为迭代次数
//    string name10="_close.tif";
//    save_img(image_close,argv[1],name10);
//    
//    cvDilate(image_close,image_dilate,element2,5);//膨胀操作
//    string name3="_dilate.tif";
//    save_img(image_dilate,argv[1],name3);
//    //
//    ////    for(y=0; y<height-1; y++)
//    ////    {
//    ////        for(x=0; x<width-1; x++)
//    ////        {
//    ////            CvScalar Ixy=cvGet2D(image_dilate,y,x);
//    //////            printf("ixy00=%f ixy11=%f ixy22=%f\n",Ixy.val[0],Ixy.val[1],Ixy.val[2]);
//    ////            CvScalar n0=cvScalar(255, 0, 0);
//    ////            cvSet2D(image_dilate,y,x,n0.val[0]-Ixy.val[0]);
//    //////            printf("ixy0=%f ixy1=%f ixy2=%f\n",Ixy.val[0],Ixy.val[1],Ixy.val[2]);
//    ////        }
//    ////    }
//    ////
//    ////    string name10="_dilate2.tif";
//    ////    save_img(image_dilate,argv[1],name10);
//    //
//    IPL image_contour=extract_max_area_contour(image_dilate);//提取出最大的轮廓
//    cvErode(image_contour,image_contour,element2,5);//最大轮廓进行腐蚀操作
//    string name4="_contour.tif";
//    save_img(image_contour,argv[1],name4);
//    //
//    //    cvMorphologyEx(image_contour,image_open,image_temp,element,CV_MOP_OPEN,3);//最大轮廓进行腐蚀操作后进行形态学开操作
//    //    string name5="_open.tif";
//    //    save_img(image_open,argv[1],name5);
//    //
//    //    IPL  image_final=and_template_original_imgs(src2,image_open);
//    //    string name6="_final.tif";
//    //    save_img(image_final,argv[1],name6);
//    //    printf("a=%s\n",argv[2]);
//    //    int flag;
//    //    if(argc==2)//判断参数个数
//    //    {
...
//    cvReleaseImage(&image_z);
//    cvReleaseImage(&image_dilate);
//    cvReleaseImage(&image_xy_BF_binary);
//    //    cvReleaseImage(&image_xz_BF_binary);
//    //    cvReleaseImage(&image_yz_BF_binary);
//    //    cvReleaseImage(&image_xy_and_xz);
//    cvReleaseImage(&imagesmoothM2);
//    cvReleaseImage(&image_close);
//    cvReleaseImage(&image_contour);
//    cvReleaseImage(&image_open);
...
//for(int x=1; x<=width-2; x++) //计算图像中像素点的梯度g_x=h(x+1,y)-h(x-1,y),g_y=h(x,y+1)-h(x,y-1)
//{
//    for(y=1; y<=height-2; y++)
//    {
//        Ix0y0=cvGet2D(src,(y-1),x);
//        Ix0y1=cvGet2D(src,(y+1),x);
//        Iy[x][y]=Ix0y1.val[0]-Ix0y0.val[0];
//        //                printf("iy=%f\n",Iy[x][y]);
//    }
//}
//
...
//    {
//        Ix1y0=cvGet2D(src,y,(x-1));
//        Ix1y1=cvGet2D(src,y,(x+1));
//        Ix[x][y]=Ix1y1.val[0]-Ix1y0.val[0];
//        //                printf("ix=%f\n",Ix[x][y]);
//    }
//}
//double ixmax,ixmin,iymax,iymin;
//double ix,iy;
//ixmax=Ix[0][0];
//ixmin=Ix[0][0];
//iymax=Iy[0][0];
...
//        ix=Ix[x][y];
//        if (ix>ixmax)
//            ixmax=ix;//max(theta_x)
//            else {};
//        if (ix<ixmin)
//            ixmin=ix;//min(theta_x)
//            else {};
//        
//        iy=Iy[x][y];
//        if (iy>iymax)
...
//    for(x=0; x<width-1; x++)
//    {
//        xmap[x][y]=255*(Ix[x][y]-ixmin)/(ixmax-ixmin);
//        ymap[x][y]=255*(Iy[x][y]-iymin)/(iymax-iymin);
//        //            printf("x=%f y=%f z=%f\n",xmap[x][y],ymap[x][y],zmap[x][y]);
//        cvSet2D(image_x,y,x,cvRealScalar(xmap[x][y]));//将map的值赋给图像中每个像素点
//        cvSet2D(image_y,y,x,cvRealScalar(ymap[x][y]));//cvrealscalar把数组的第一个值置为想要的数（即为 double val0 ），其他三个数均为零。
//    }
