...
//    char extn[FILENAME_MAX];
//	_splitpath(filename.c_str(), NULL, NULL, fname, extn);
//    	string temp = fname;
    string savingfile(filename);
    string shortstring=savingfile.substr(savingfile.find_last_of("/")+1,savingfile.length()-savingfile.find_last_of("/"));
